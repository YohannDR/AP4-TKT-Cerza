...
const { findAll, findAllCompl, findAllComplOrNull, create, findOne, findOneCompl, update, updateidU, updateMfin, updateCom, assigner, drop } = require('../controllers/missionsController');
...
router.put('/missionAssigner/:id', assigner);
